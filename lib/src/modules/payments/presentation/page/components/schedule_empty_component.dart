...
import 'schedule_page.dart/transactions_list_component.dart'; // Componente PaymentScheduleDashboard
              ...
              child: Padding(
                ...
                child: BlocBuilder<PaymentsBloc, PaymentsState>(
                  builder: (context, state) {
                    ...
                    final scheduledList = state.paymentsInfo?.paymentsScheduled;
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        // Exibe conteúdo diferente conforme a aba selecionada e se há dados
                        if (isPayments) ...[
                          if (isScheduledEmpty) ...[
